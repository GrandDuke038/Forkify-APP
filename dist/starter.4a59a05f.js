...
},{"core-js/modules/web.immediate.js":"bzsBv","./model":"3QBkH","./views/recipeView":"3wx5k","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadRecipe = async function(id) {
    try {
        ...
        //temp error handling
        console.error(`${err} \u{2666}\u{FE0F}\u{2666}\u{FE0F}\u{2666}\u{FE0F}\u{2666}\u{FE0F}`);
        throw err;
    }
};
...
},{"regenerator-runtime/runtime.js":"f6ot0","./config.js":"2hPh4","./helpers.js":"7nL9P","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
class RecipeView {
    ...
    renderSpinner() {
        const markup = `
    <div class="spinner">
    <svg> <use href="${(0, _iconsSvgDefault.default)}#icon-loader"></use>
            </svg>
          </div> 
    `;
        this.#clear();
    ...
    renderError(message = this.#ErrorMessage) {
        const markup = `<div class="error">
            ...
            <p>${message}</p>}
            No recipes found for your query. Please try again!</p>
          </div>`;
        this.#clear();
        this.#parentElement.insertAdjacentHTML('afterbegin', markup);
    }
